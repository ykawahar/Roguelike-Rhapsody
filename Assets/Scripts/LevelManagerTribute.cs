...
public class LevelManagerTribute : MonoBehaviour
{
    ...
    void SpawnTribute(){
        ...
        GameObject leftStatue = Instantiate(statue, new Vector3(transform.position.x-10, transform.position.y+6f, transform.position.z+8), Quaternion.Euler(30,0,0));
        ...
        GameObject rightStatue = Instantiate(statue, new Vector3(transform.position.x+10, transform.position.y+6f, transform.position.z+8), Quaternion.Euler(30,0,0));
